...
export async function POST(req: Request) {
  ...
  if (eventType === "user.created") {
    ...
    return NextResponse.json({ message: "mongoUser updated", user: mongoUser })
  }
  ...
  return NextResponse.json({ message: "Error occured", status: 201 })
}
